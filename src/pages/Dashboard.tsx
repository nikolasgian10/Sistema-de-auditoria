  ...
  return (
    <div className="space-y-6">
          ...
          <CardContent>
            {audits.length > 0 ? (
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie data={statusPieData} dataKey="value" nameKey="name" cx="50%" cy="45%" outerRadius={80} label={({ name, percent }) => `${name} ${(percent * 100).toFixed(0)}%`}>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader><CardTitle className="text-base">Tendência Semanal</CardTitle></CardHeader>
          <CardContent>
            ...
            ) : <p className="text-sm text-muted-foreground py-8 text-center">Sem dados recentes</p>}
          </CardContent>
        </Card>
      </div>
